...
<xsl:stylesheet
        ...
        xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xal="http://www.w3.org/1999/XSL/Format"
    ...
    <xsl:template name="initial.page.number">
        ...
        <xsl:choose>
            <xsl:when test="$element = 'toc'">2</xsl:when>
            <xsl:when test="$element = 'dedication'">2</xsl:when>
            <!-- double-sided output -->
