        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="root.properties">
            ...
            <fo:layout-master-set>
                ...
                <fo:simple-page-master
                        ...
                        margin-right="0mm">
                    <!--Макет основной области -->
                    <fo:region-body margin-top="5mm" margin-left="20mm" margin-bottom="70mm" margin-right="5mm"
                    />
                    <!--Макет верхнего колонтитула -->
                    <fo:region-before extent="5mm"/>
                    <!--Макет нижнего колонтитула -->
                ...
                <fo:simple-page-master
                        ...
                        margin-right="0mm">
                    <!--Макет основной области -->
                    <fo:region-body margin-top="5mm" margin-left="20mm" margin-bottom="25mm" margin-right="5mm"
                    />
                    <!--Макет верхнего колонтитула -->
                    <fo:region-before extent="5mm"/>
                    <!--Макет нижнего колонтитула -->
