...
<xsl:attribute-set name="formal.title.properties" use-attribute-sets="normal.para.spacing">
  ...
  <xsl:attribute name="space-after.minimum">0.5mm</xsl:attribute>
  <xsl:attribute name="space-after.optimum">0.5mm</xsl:attribute>
  <xsl:attribute name="space-after.maximum">0.5mm</xsl:attribute>
